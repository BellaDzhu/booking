...
|3              |[Минипроекты по работе с грязными данными](https://github.com/belladzhu/python_projects/tree/main/working-with-dirty-data)|В проектах я провожу работу с грязными данными, визуализирую данные и делаю небольшой проект по фильтрации данных|`предобработка данных` `Python` `Pandas` `NumPy` `os` `warnings` `Seaborn` `Matplotlib`  |
